...
<div class="tab-content">
    <div id="secao" class="container tab-pane active">
        ...
        <button type="button" class="btn btn-primary" onclick='acaoAdm(`secao`, `criar`)'>+</button>
        <table class="table">
            <thead>
            <tr><th>Id</th>
                <th>Ordem</th>
    ...
    <div id="forum" class="container tab-pane fade" >
        ...
        <button type="button" class="btn btn-primary" onclick='acaoAdm(`forum`, `criar`)'>+</button>
        <table class="table">
            <thead>
            <tr><th>Id</th>
